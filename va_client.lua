...
m.prefix = '^6[SETNAMEHERE] '
m.suffix = '^6.'

-- You can make as many messages as you want.
-- You can use ^0-^9 in your messages to change text color.
m.messages = {   
    '^1Samtliga skall befinna sig inne i våran Discord: https://discord.gg/VaeKqhh',
    '^1Ambulanser sökes.',
    '^1Samtliga regler finns på Discord.',
    '^1Auto restart på servern är  06.00 10.00 13.00 18.00 22.00 02.00.',
}
